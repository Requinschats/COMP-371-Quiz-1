...
void Characters::DrawR(TranslateMatrix *translateMatrix, float x_position, float z_position, int letterIndex) {
    vec3 color = getColorFromState(letterIndex);
    Cube *cube = new Cube(color.x, color.y, color.z, RenderMode::triangles);
...
void Characters::DrawA(TranslateMatrix *translateMatrix, float x_position, float z_position, int letterIndex) {
    vec3 color = getColorFromState(letterIndex);
    Cube *cube = new Cube(color.x, color.y, color.z, RenderMode::triangles);
...
void Characters::DrawD(TranslateMatrix *translateMatrix, float x_position, float z_position, int letterIndex) {
    vec3 color = getColorFromState(letterIndex);
    Cube *cube = new Cube(color.x, color.y, color.z, RenderMode::triangles);
...
void Characters::DrawE(TranslateMatrix *translateMatrix, float x_position, float z_position, int letterIndex) {
    vec3 color = getColorFromState(letterIndex);
    Cube *cube = new Cube(color.x, color.y, color.z, RenderMode::triangles);

    translateMatrix->setPosition(x_position, baseHeight + this->letterHeight, z_position);
    translateMatrix->setSize(this->lineWidth, this->letterHeight, this->lineWidth);
    translateMatrix->setObjectRotationAngle(220, vec3(1.5, 1, 0));
    translateMatrix->bindTranslationMatrix(this->shaderProgram);
    cube->Draw();
...
void Characters::DrawT(TranslateMatrix *translateMatrix, float x_position, float z_position, int letterIndex) {
    vec3 color = getColorFromState(letterIndex);
    Cube *cube = new Cube(color.x, color.y, color.z, RenderMode::triangles);
